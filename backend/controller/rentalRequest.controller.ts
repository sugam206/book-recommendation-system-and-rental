...
import { RentalRequestModel } from '../modules/rentalRequest/rentalRequest.model.ts';
...
export class RentalRequestController {
    ...
    canUserRent = asyncHandeler(async (req: Request, res: Response) => {
        ...
        const canRent = user.rentalStatus === 'approved';
        const reason = !canRent ? `Your rental status is: ${user.rentalStatus}` : undefined;
