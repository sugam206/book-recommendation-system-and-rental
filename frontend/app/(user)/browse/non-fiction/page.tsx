...
export default function Page() {
    ...
    const nonFictionBooks = books.filter(book => {
        ...
        return genre?.toLowerCase() === 'non-fiction';
    }) as IBook[];

    const totalPages = Math.ceil(nonFictionBooks.length / limit);
    const displayBooks = nonFictionBooks.slice((currentPage - 1) * limit, currentPage * limit).map(b => ({
        ...b,
    ...
    return (
        <div className="p-6 max-w-6xl mx-auto">
            <BookGrid
                ...
                emptyMessage="No non-fiction books found."
            />
            {totalPages > 1 && (
